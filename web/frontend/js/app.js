...
/***/ function(module, exports, __webpack_require__) {
	...
	var _plyr = __webpack_require__(5);
	...
	exports.default = {
	    ...
	    init: function init() {
	        ...
	        this.audio = (0, _jquery2.default)('audio');

	        this.$volumeInput = (0, _jquery2.default)('#volumeRange');

	        /**
	         * Listen to 'error' event on the audio player and play the next song if any.
	         */
	        document.querySelector('.plyr').addEventListener('error', function (e) {
	            _this.playNext();
	        }, true);
	        ...
	        document.querySelector('.plyr').addEventListener('timeupdate', function (e) {
	            if (!_this.player.media.duration || _this.player.media.currentTime + 10 < _this.player.media.duration) {
	                return;
	            }

	            // The current song has only 10 seconds left to play.
	            var nextSong = queueStore.next;
	            if (!nextSong || nextSong.preloaded) {
	                return;
	            }

	            var $preloader = (0, _jquery2.default)('<audio>');
	         ...
	         */
	        this.$volumeInput.on('input', function (e) {
	            _this.setVolume((0, _jquery2.default)(e.target).val());
	        });
	    ...
	    play: function play(song) {
	        ...
	        (0, _jquery2.default)('title').text(song.title + ' ♫ ' + config.appTitle);
	        (0, _jquery2.default)('.plyr audio').attr('title', song.artist.name + ' - ' + song.title);
	    ...
	    changeRepeatMode: function changeRepeatMode() {
	        var idx = this.repeatModes.indexOf(preferences.repeatMode) + 1;
	     ...
	     */
	    stop: function stop() {
	        (0, _jquery2.default)('title').text(config.appTitle);
	        this.player.pause();
	        this.player.seek(0);
	     ...
	     */
	    queueAndPlay: function queueAndPlay() {
	        var _this2 = this;

	        var songs = arguments.length <= 0 || arguments[0] === undefined ? null : arguments[0];
	        var shuffled = arguments.length <= 1 || arguments[1] === undefined ? false : arguments[1];
	        ...
	        this.app.$nextTick(function () {
	            return _this2.play(queueStore.first);
	        });
	    },
	     ...
	     */
	    playFirstInQueue: function playFirstInQueue() {
	     ...
	     */
	    playAllByArtist: function playAllByArtist(artist) {
	        var shuffled = arguments.length <= 1 || arguments[1] === undefined ? true : arguments[1];
	    ...
	    playAllInAlbum: function playAllInAlbum(album) {
	        ...
	        if (!shuffled) {
	            this.queueAndPlay((0, _lodash.orderBy)(album.songs, 'track'));
